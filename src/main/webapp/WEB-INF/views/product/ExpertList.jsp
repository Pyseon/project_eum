   	...
   	<div class="posting-wrap">
   		<c:forEach items="${list }" var="c" varStatus="i">
   			<div class="posting-item" style="cursor: pointer;" onclick="location.href='/productDetail.do?productNo=${c.productNo }&expertNo=${c.expertNo }';" >
   				<img src="./img/product/ExpertList/ba7da2c7fa66b6a81d357df4a4113333.jpg">
   				<div class="posting-connect">
   					...
   					<ul style="margin-top:0px;">
						...
						<div style="border-bottom: 1px solid rgba(220, 220, 220, 0.59); "></div>
						</li>
					</ul>
					...
					<ul>
						<li>
							<div class="t4">
								...
								<div class="t4-right" style="line-height: 2; display: flex; margin: 0px -9px 0px 0px;">
									<div style="line-height: 2; display: inline-flex;"><span class="material-icons icons-message">message</span>
									<span style="line-height: 2.5;">${c.revCount } </span></div>
									 &nbsp;
									<div style="line-height: 2; display: inline-flex;"><span class="material-icons icons-star">star</span>
									<span style="line-height: 2.5;">${c.reviewStar }</span></div>
								</div>	
		...
		<span class="t2" style="margin: 0px 0 30px 0px;">
			...
			&nbsp;
			<span id="fixed-price" style="width: auto; font-size: 12px; font-style: italic; font-weight: bold; margin: 1px 0 0px 0px;">
			<fmt:formatNumber value="${c.cost }" pattern="#,###,###,###,###"/>원
			</span>
		</span> 
		</c:otherwise>
