			...
			<div class="container">
				<div class="row">
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li class="dropdown"><a href="#" id="nav-all-category">전체
										카테고리<i class="fa fa-angle-down"></i>
								</a>
									<ul role="menu" class="sub-menu">
										<li><a href="#">법률/세무</a>
										<ul role="menu" class="sub-menu2">
												<li><a href="/productDetail.do?productNo=18&expertNo=8">변호사</a></li>
												<%--임시코드 상품 리스트 완성되면 지울게요.--%>
												<li><a
													href="/productDetail.do?productNo=19&expertNo=62">노무사</a></li>
					...
					<div class="col-sm-3" style="text-align: right">
						<a href="login.html" class="fc-1">원하시는
							상담/클래스가 없나요?</a>
					</div>
				</div>
			</div>
