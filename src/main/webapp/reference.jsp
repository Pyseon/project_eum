...
<div class="page-content">
	...
	<div>
		<h3>이미지 사이즈</h3>
		<img class="img-0 bc1">size1</img> <img class="img-1 bc2">size2</img>
	</div>
	<br />
	<div>
		<h2>입력양식</h2>
	...
	<div class="card-wrap">
		<img class="card-img " src="./img/promo_big.jpg" alt=""
			onload="imgOnload(this)" style="display: inline;">
		<figcaption>
				...
				<div class="card-icon card-flex">
					<div class="card-like">
						<i class="fa-solid fa-heart"></i> <span
							class="noto-sb mb-1 fs-bold">7</span>
					</div>
					<div class="card-comment">
						<i class="fa-solid fa-message"></i> <span
							class="noto-sb mb-1 fs-bold">8</span>
					</div>
				</div>
			</div>
			<div class="card-title fs-bold">요즘 나의 은밀한 취미</div>
			<div class="card-content">가족들 모르게 몰래 야식을 먹고 있습니다. 아주 맛있습니다
				즐거워요! 행복합니다!! 빨리 야식두번 드세요 좋습니다 배달시키세요 당장</div>
			<div class="card-info card-flex">
				...
				<div class="card-readcount">
					<span class="mr-1">조회수</span> <span>912</span>
				</div>
			</div>
		</figcaption>
	</div>
	...
	<table class="review">
		<tr class="review-info">
			...
			<td class="review-book-info"><span>객실타입 : </span> <span>스위트</span>
				<span>| 인원 : </span> <span>성인 2, 소아 1</span> <span>| 김*딩님 </span></td>
			<td>
		...
		<tr class="review-content">
			<td colspan="3">
				...
				<div class="review-image">
					<img src="img/고해상도 1.jpg"> <img src="img/고해상도 2.jpg"> <img
						src="img/고해상도 3.jpg">
				</div>
			</td>
		</tr>
